...
\frame{ \vfill \centerline{ \includegraphics[width=9cm]{cwig}} \vfill
...
\frame{
  \frametitle{The team}
  \begin{center}
    \includegraphics[width=4cm]{betcke}
    \includegraphics[width=4cm]{cotter}
    \includegraphics[width=4cm]{misener}
    \includegraphics[width=4cm]{guillas}\\
    \includegraphics[width=4cm]{kalise}
    \includegraphics[width=4cm]{mbetcke}
    \includegraphics[width=4cm]{ni}
    \includegraphics[width=4cm]{shahrezaei}
  \end{center}
